    ...
    (<DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        onPointerDownOutside={(event) => {
          // Ignore clicks inside nested Radix popper content (Popover/Select/DropdownMenu),
          // which portals to document.body and would otherwise register as "outside" the
          // dialog and close it before the click inside that popover is handled.
