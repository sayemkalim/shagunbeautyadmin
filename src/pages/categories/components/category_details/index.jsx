          ...
          <Dialog open={!!previewImg} onOpenChange={() => setPreviewImg(null)}>
            <DialogTrigger asChild>
              <img
                src={product.images}
                alt={product.name}
                className="bg-muted border-border h-[360px] w-full cursor-pointer rounded-xl border object-contain shadow-elegant-sm"
                ...
                <Dialog key={idx}>
                  <DialogTrigger asChild>
                    <img
                      src={img}
                      alt={`Extra ${idx + 1}`}
                      className="bg-muted border-border hover:border-primary/50 h-16 w-16 cursor-pointer rounded-md border object-contain transition-colors"
