...
const SuperAdminTable = ({ setadminsLength, params, setParams }) => {
  ...
  const onNavigateToEdit = (id) => {
    navigate(`/dashboard/super-admin/edit/${id}`);
  };
  ...
  return (
    <>
      <CustomTable
        ...
        isLoading={isLoading}
        error={error}
        emptyStateMessage="No Super-Admin found"
        perPage={perPage}
